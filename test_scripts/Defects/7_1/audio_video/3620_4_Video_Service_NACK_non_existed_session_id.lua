...
-- 3. App tries to start Video service over 5th SDL protocol with non existed session id
-- SDL does:
...
common.Title("Test")
common.Step("Start VIDEO Service, NACK", common.startServiceNACKwithNonExistedSessionId, { serviceParams })
