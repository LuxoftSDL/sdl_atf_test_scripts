...
-- 3. App tries to start protected Audio service over 5th SDL protocol with non existed session id
-- SDL does:
...
common.Title("Test")
common.Step("Start protected AUDIO Service, NACK", common.startServiceNACKwithNonExistedSessionId,
