...
-- 3) HMI sends BC.OnResetTimeout(resetPeriod = 11000) to SDL for RPC_1 with requestId for RPC_2 and
--   BC.OnResetTimeout(resetPeriod = 13000) for RPC_2 with requestId for RPC_1 right after receiving requests on HMI
