...
common.Title("Test")
common.Step("SubscribeVehicleData with invalid request for gearStatus param", common.processRPCFailure,
  { "SubscribeVehicleData", "INVALID_DATA", common.invalidValue.invalidType })
