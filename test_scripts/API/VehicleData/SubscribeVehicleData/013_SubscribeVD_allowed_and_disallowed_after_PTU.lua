---------------------------------------------------------------------------------------------------
-- Description: Check that SDL filters out param from SubscribeVehicleData request
...
-- SDL does:
-- - a) transfer SubscribeVehicleData to HMI but filter out disallowed <vd_param> parameter
---------------------------------------------------------------------------------------------------
