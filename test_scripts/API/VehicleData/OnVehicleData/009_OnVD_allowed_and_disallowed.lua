...
for param in common.spairs(common.getVDParams(true)) do
  ...
  common.Title("Test")
  common.Step("RPC " .. common.rpc.sub .. " SUCCESS", common.processSubscriptionRPCAllParams, { common.rpc.sub, param })
  common.Step("RPC " .. common.rpc.on .. " ignored", common.sendOnVehicleDataAllParams, { param, common.isExpected })
