---------------------------------------------------------------------------------------------------
-- Description: Check that SDL filters out param from UnsubscribeVehicleData request
...
-- SDL does:
-- - a) transfer UnsubscribeVehicleData to HMI but filter out disallowed <vd_param> parameter
---------------------------------------------------------------------------------------------------
