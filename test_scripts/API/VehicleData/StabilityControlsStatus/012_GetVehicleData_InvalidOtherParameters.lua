...
common.Step("Send GetVehicleData, speed structure invalid",
  common.getVehicleDataGenericError, { reqParams, hmiResParams_invalidSpeedAsString })
common.Step("Send GetVehicleData, speed structure invalid",
  common.getVehicleDataGenericError, { reqParams, hmiResParams_invalidSpeedAsBool })
common.Step("Send GetVehicleData, other structure has invalid values",
  common.getVehicleDataGenericError, { reqParams, hmiResParams_invalidSpeedType })
common.Step("Send GetVehicleData, speed structure has outrange value",
  common.getVehicleDataGenericError, { reqParams, hmiResParams_outrangeSpeed })
common.Step("Send GetVehicleData, stabilityControlsStatus structure absent",
  common.getVehicleDataSuccessExpectation, { reqParams, reqParams, hmiResParams_speedAbsent })
