...
common.Step("App1 interiorVD subscription for " .. moduleType .. " " .. moduleId1,
  common.GetInteriorVehicleData, { moduleType, moduleId1, isSubscribe, default, default, appIdFirstApp })
common.Step("App2 interiorVD subscription for " .. moduleType .. " " .. moduleId2,
  common.GetInteriorVehicleData, { moduleType, moduleId2, isSubscribe, default, default, appIdsecondApp  })
