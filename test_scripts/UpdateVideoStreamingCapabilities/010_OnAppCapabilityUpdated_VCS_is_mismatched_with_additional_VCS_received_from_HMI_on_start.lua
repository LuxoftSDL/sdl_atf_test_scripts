...
--
-- Sequence:
-- 1. App1 sends OnAppCapabilityUpdated for VIDEO_STREAMING capability type with videoStreamingCapability that doesn't 
...
local appCapability = {
  appCapability = {
    ...
    videoStreamingCapability = common.getAnotherVideoStreamingCapability()
  }
}
