...
common.Step("Register App1", common.registerAppWOPTU, { appId1, devices.default })
common.Step("Register App2", common.registerAppWOPTU, { appId2, devices.webEngine })
...
common.Step("App2 receives OnExitApplication", common.processResourceConstraintExit,
  { appId2, devices.webEngine, { devices.default }})
